class Api::V1::UsersController < ApplicationController
	...
	def user_params
		params.require(:user).permit(:email, :name, :handle, :description, notification_settings: [:comment_on_my_item, :comment_on_my_converation, :follow_post, :new_follower, :group_invite, :ai_daily])
	end
